...
public class MainActivity extends AppCompatActivity {
    ...
    // TOCOMPLETEDDO (32) After you save mWeatherData, call notifyDataSetChanged
    // Within ForecastAdapter.java /////////////////////////////////////////////////////////////////
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            // COMPLETED (46) Instead of setting the text to "", set the adapter data to null before refreshing

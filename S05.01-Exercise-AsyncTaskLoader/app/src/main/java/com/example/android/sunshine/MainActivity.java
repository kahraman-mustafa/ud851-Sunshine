...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final int SUNSHINE_WEATHER_LOADER = 111;
    ...
    private void loadWeatherData() {
        ...
        loaderManager.initLoader(SUNSHINE_WEATHER_LOADER, bundle, this);
    }

    private void forceLoadWeatherData() {
        showWeatherDataView();
        ...
        LoaderManager loaderManager = getSupportLoaderManager();
        loaderManager.restartLoader(SUNSHINE_WEATHER_LOADER, bundle, this);
    }
